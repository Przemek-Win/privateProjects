...
* Host: MSI;
* Project Path: C:\Users\Monika\Documents\SGH\SAS\Data Mining;
* Project Name: Projekt_1;
* Diagram Id: EMWS1;
* Diagram Name: Diagram_1;
* Generated by: Monika;
* Date: 01JUN2015:17:48:15;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* Macro Variables;
*------------------------------------------------------------*;
...
%let EM_PROJECTNAME =;
%let EM_WSNAME =;
%let EM_WSDESCRIPTION =Diagram_1;
...
put '*------------------------------------------------------------* ;';
put 'libname dane ''C:\Users\Monika\Documents\SGH\SAS\Data Mining\dane strona po kodzie\dane strona po kodzie'';';
run;
%end;
...
AttributeValue='NOMINAL';
Output;
Variable='stan_cywilny';
AttributeName="LEVEL";
AttributeValue='BINARY';
Output;
Variable='wyksztalcenie';
AttributeName="LEVEL";
AttributeValue='NOMINAL';
Output;
run;
...
output;
_TYPE_="PREDICTED";
VARIABLE="P_komputer1";
LABEL="Przewidywane: komputer=1";
LEVEL="1";
EVENT="";
ORDER="";
FORMAT="";
...
output;
_TYPE_="RESIDUAL";
VARIABLE="R_komputer1";
LABEL="Residual: komputer=1";
LEVEL="1";
EVENT="";
ORDER="";
FORMAT="";
...
output;
_TYPE_="PREDICTED";
VARIABLE="P_komputer0";
LABEL="Przewidywane: komputer=0";
LEVEL="0";
EVENT="";
ORDER="";
FORMAT="";
...
output;
_TYPE_="RESIDUAL";
VARIABLE="R_komputer0";
LABEL="Residual: komputer=0";
LEVEL="0";
EVENT="";
ORDER="";
FORMAT="";
...
output;
id= "Ids";
property="EM_DECMETA_komputer";
value= "WORK.Ids_komputer_DM";
output;
id= "Ids";
property="EM_DECDATA_komputer";
value= "WORK.Ids_komputer_DD";
output;
id= "Ids";
property="EM_FILE_EMNOTES";
