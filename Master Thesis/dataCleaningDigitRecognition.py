...
import numpy as np
import os, sys, tarfile, h5py, random
...
digitFileTrain=DigitStructFile(os.path.join('D:/Python/train','digitStruct.mat'))
train_data=digitFileTrain.getAllDigitStructure_ByDigit()
print('Success!')

print('Getting digit structure for test data...')
digitFileTest=DigitStructFile(os.path.join('D:/Python/test','digitStruct.mat'))
test_data=digitFileTest.getAllDigitStructure_ByDigit()
print('Success!')


print('Getting digit structure for extra data...')
digitFileExtra=DigitStructFile(os.path.join('D:/Python/extra','digitStruct.mat'))
...
print('Pickling data...')
pickle_file = 'D:/Magisterka/magisterka\\SVHN.pickle'
